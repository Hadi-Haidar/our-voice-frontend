...
export default function Signup() {
    ...
    // step 1 = info l user, step 2 = l OTP code
    ...
    // fn la ndakhel l ma3loumet w ntalib l OTP
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // badal ma nkebbo 3al home, mnb3ato 3al step 2 la ya3ti l OTP
            setStep(2);
        } catch (err) {
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            await verifyEmail({ email: formData.email, otp_code: otp });
            // bs yemchi l hal byrouh 3al login page
            navigate("/login");
        } catch (err) {
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                            {step === 1 ? t("auth.signup.title") : "Verify your Email"}
                        </h1>
                        <p className="text-gray-600 dark:text-gray-400">
                            {step === 1 ? t("auth.signup.subtitle") : "We just sent a 6-digit code to your email."}
                        </p>
                    </div>
                        ...
                        <form onSubmit={handleVerifyOtp} className="space-y-4">
                            ...
                            <div>
                                <input
                                    ...
                                    required
                                    maxLength={6}
                                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-white focus:border-transparent transition-all text-center tracking-widest text-lg"
                                />
                            </div>
